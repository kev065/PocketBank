    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          ...
          style: TextStyle(
              color:
                  Colors.white), // Sets the AppBar title text color to white.
        ),
      ...
      body: Padding(
        padding: const EdgeInsets.all(
            16.0), // Padding adds space (16 pixels) around the content.

        // Column widget arranges its children vertically.
        child: Column(
          mainAxisAlignment:
              MainAxisAlignment.center, // Center-aligns the content vertically.
          children: <Widget>[
            ...
            TextField(
              decoration: InputDecoration(
                ...
                focusedBorder: OutlineInputBorder(
                  borderSide: BorderSide(
                      color:
                          Colors.black), // Sets focused border color to black.
                ),
              ),
            ),
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                border: OutlineInputBorder(
                  borderSide: BorderSide(
                      color:
                          Colors.black), // Black border around the input field.
                ),
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pop(
                    context); // Go back to the Login page after the user registers.
              },
