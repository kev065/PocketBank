    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          ...
          style: TextStyle(
              color: Colors.white), // Setting the AppBar title text to white.
        ),
      ...
      body: Padding(
        padding: const EdgeInsets.all(
            16.0), // Padding adds 16 pixels of space around the content.
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            TextField(
              ...
              decoration: InputDecoration(
                labelText:
                    'Password', // Label displayed inside the password input field.
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor:
                    Colors.teal, // Teal background color for the button.
                foregroundColor:
                    Colors.black, // Black text color on the button.
              ),
            ...
            TextButton(
              onPressed: () {
                ...
                Navigator.pushNamed(
                    context, '/register'); // Go to the register page.
              },

              // The text inside the TextButton.
              child: Text(
                  'Don\'t have an account? Register here'), // Displayed text for registration link.
